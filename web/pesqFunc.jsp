<%-- 
    Document   : pesqFunc
    Created on : 27/02/2013, 10:16:21
    Author     : User
--%>
    ...
    <body>
        <div id="Principal">
            <div id="Conteudo">
                ...
                <div id="pequenocad">
                    <form method="post" action="FuncionarioControle?cmd=pesquisar">
                        <fieldset >      
                            <div id="faserPesquisa">
                                <legend  class="legendPesq">Pesquisar Funcionario</legend>
                                <label class="labelPesq">Nome do Funcionario :</label>
                        ...
                        <table>
                            ...
                            <c:forEach var="func" items="${funcionarios}">
                                <tr>
                                    ...
                                    <td>${func.email}</td>  
                                    <td>
                                        <a href="FuncionarioControle?cmd=cadCompleto&id=${func.id}" ><input class="bottonVerMais" type="submit" title="Ver o cadastro completo" value=""/></a>
                                    </td> 
                                    <td>
                                        <a href="FuncionarioControle?cmd=atuaFuncionario&id=${func.id}"><input class="bottonAlterar" type="submit" title="Aterar dados do Funcionario" value=""/></a>
                                    </td>
                                    <td>
                                        <a href="FuncionarioControle?cmd=excluir&id=${func.id}"><input class="bottonExcluir" type="submit" title="Excliur dados do Funcionario" value=""/></a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </table>            
