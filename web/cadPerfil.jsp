<%-- 
    Document   : cadPerfil
    Created on : 27/02/2013, 09:39:13
    Author     : User
--%>
    ...
    <body>
        <div id="Principal">
            <div id="Conteudo">
                ...
                <div id="pequenocad">
                    <form method="post" action="PerfilControle?cmd=salvar">
                        <fieldset >       

                            <div id="cadPequeno">
                            <legend class="legendPesq">Cadastro de Perfil</legend>
                                <label>Perfil :</label><br />
                                <input class="cad"type="text" name="perfil"/><br />                            
