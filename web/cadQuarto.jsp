<%-- 
    Document   : cadQuarto
    Created on : 26/02/2013, 22:40:01
    Author     : User
--%>
    ...
    <body>
        <div id="Principal">
            <div id="Conteudo">
                ...
                <div id="pequenocad">
                <form method="post" action="QuartoControle?cmd=salvar">
                    <fieldset >       

                        <div id="cadPequeno">
                        <legend class="legendPesq">Cadastro de Quarto</legend>
                            <label>Numero :</label><br />
                            <input class="cad"type="text" name="numero"/><br />
                            <label>Capacidade :</label><br />
                            <input class="cad" type="text" name="capacidade"/><br />
