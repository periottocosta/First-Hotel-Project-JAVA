<%-- 
    Document   : pesqUsuario
    Created on : 27/02/2013, 10:42:20
    Author     : User
--%>
    ...
    <body>
        <div id="Principal">
            <div id="Conteudo">
                ...
                <div id="pequenocad">
                    <form method="post" action="UsuarioControle?cmd=pesq">
                        <fieldset >                                  
                            <div id="faserPesquisa">
                                <legend class="legendPesq">Pesquisar Usuário</legend>
                                <label class="labelPesq">Nome :</label>
                        ...
                        <table>
                            ...
                            <c:forEach var="func" items="${funcionarios}">
                                <tr>
                                    <td>${func.nome}</td>
                                    <td>${func.cpf}</td>
                                    <td>${func.usuario.login}</td>
                                    <td>${func.email}</td>
                                    <td>${func.usuario.idPerfil.tipo}</td>                                  
                                    <td>
                                        <a href=""><input class="bottonAlterar" type="submit" title="Aterar Dados de Usuário" value=""/></a>
                                    </td>                                    
                                    <td>  
                                        <a href="UsuarioControle?cmd=excluir&id=${func.id}&idUsuario=${func.usuario.id}"><input class="bottonExcluir" type="submit" title="Excliur dados de usuário" value=""/></a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </table>            
