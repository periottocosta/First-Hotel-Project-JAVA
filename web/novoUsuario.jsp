<%-- 
    ...
    Created on : 27/02/2013, 10:05:30
    Author     : User
--%>
...
<html>
    <head>
        ...
        <title>Pesquisar novo usuário</title>
    </head>
    <body>
        <div id="Principal">
            <div id="Conteudo">
                ...
                <div id="pequenocad">
                    <form method="post" action="UsuarioControle?cmd=novoUsuario">
                        <fieldset >      
                            <div id="faserPesquisa">
                                <legend class="legendPesq">Pesquisar novo usuário</legend>
                                <label class="labelPesq">Nome do novo usuário :</label>
                        ...
                        <table>
                            ...
                            <c:forEach var="func" items="${funcionarios}">
                                <tr>
                                    ...
                                    <td>${func.email}</td>  
                                    <td>  
                                        <a href="UsuarioControle?cmd=comboPerfil&id=${func.id}&nome=${func.nome}&email=${func.email}"><input id="buton3" type="submit" value="Criar Usuário"/></a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </table>            
