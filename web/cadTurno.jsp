<%-- 
    Document   : cadTurno
    Created on : 27/02/2013, 09:32:55
    Author     : User
--%>
    ...
    <body>
        <div id="Principal">
            <div id="Conteudo">
                ...
                <div id="pequenocad">
                    <form method="post" action="TurnoControle?cmd=salvar">
                        <fieldset >       

                            <div id="cadPequeno">
                                <legend class="legendPesq">Cadastro de Turno</legend>
                                <label>Nome :</label><br />
                                <input class="cad"type="text" name="nome"/><br />                            
